% Training a neural ODE to estimate dynamics of the Buck Converter System
% out.vars(:, 3) = I_L, current across the inductor

% clear

%% what do i want to input into neural network??
% - Vin, V_L, V_out, I_L, 
